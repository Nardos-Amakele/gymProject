  ...
  return (
    <div>
      <section className="text-white mb-8 lg:mb-24 px-4 sm:px-6 lg:px-[7rem]">
        <div className="container mx-auto max-w-6xl"> {/* Set max-width here */}
          <div className="flex flex-col lg:flex-row items-stretch">
            ...
            <div className="sm:w-full lg:w-1/2 flex items-stretch mb-8 lg:mb-0 transition-transform transform hover:scale-105 relative">
              <Link href="./about" className="relative w-full h-[50vh] lg:h-auto rounded-tl-[164px] rounded-br-[6px] rounded-bl-[6px] bg-black rounded-xl overflow-hidden">
                <Image
                  src={aboutImage1}
                  alt="About Us Hero"
